...
const services = [
  {
    title: "SEO Services KSA",
    desc: "Targeting high-volume Saudi search intent in Arabic and English to build organic inquiries and authority.",
    icon: LineChart,
    href: "/seo-services",
  },
  {
    title: "Web Design KSA",
    desc: "Bespoke corporate website designs built on Next.js for lightning-fast speeds and localized GCC layouts.",
    icon: Code2,
    href: "/web-design-development",
  },
  {
    title: "Digital Marketing KSA",
    desc: "Deploying high-performance ad strategies across Google and major social networks to acquire premium customers.",
    icon: Megaphone,
    href: "/digital-marketing",
  },
  {
    title: "Social Media Management KSA",
    desc: "Crafting visual templates, localized copy, and organic engagement plans tailored to Saudi Arabia's demographics.",
    icon: Eye,
    href: "/social-media-management",
  },
  {
    title: "Branding & Identity KSA",
    desc: "Comprehensive visual branding, vector logos, and design sheets to position your brand as a market leader.",
    icon: PenTool,
    href: "/branding-creative",
  },
  {
    title: "AI Solutions KSA",
    desc: "Integrating custom automation structures, lead qualifying widgets, and intelligent CRM pipeline linkages.",
    icon: Cpu,
    href: "/ai-solutions",
  },
  {
    title: "UI/UX Design KSA",
    desc: "Designing responsive interfaces, interactive prototypes, and conversion pathways for digital systems.",
    icon: Activity,
    href: "/ui-ux-design",
  },
  {
    title: "Mobile App Development KSA",
    desc: "Engineering premium cross-platform iOS and Android mobile apps using native performance frameworks.",
    icon: Smartphone,
    href: "/mobile-app-development",
  },
  {
    title: "CRM Automation KSA",
    desc: "Architecting HubSpot, Salesforce, or custom WhatsApp Business systems to track pipelines and automate leads.",
    icon: HeartHandshake,
    href: "/crm-automation",
  },
  {
    title: "Content Marketing KSA",
    desc: "Authoring high-intent bilingual blog posts, articles, and whitepapers that secure search footprint authority.",
    icon: ShoppingCart,
    href: "/content-marketing",
  },
  {
    title: "Video Production KSA",
    desc: "Producing corporate introductory videos, social ads, and cinematic product animations.",
    icon: BarChart2,
    href: "/video-production",
  },
  {
    title: "Email Marketing KSA",
    desc: "Developing automated newsletter triggers, conversion-focused sequences, and visual nurture workflows.",
    icon: Inbox,
    href: "/email-marketing",
  },
  {
    title: "Reputation Management KSA",
    desc: "Tracking online search reviews, managing local trust signals, and monitoring brand sentiment.",
    icon: ShieldAlert,
    href: "/reputation-management",
  },
  {
    title: "Hosting & Maintenance KSA",
    desc: "Providing secure managed cloud hosting, Core Web Vitals checks, and responsive developer support.",
    icon: Code2,
    href: "/hosting-maintenance",
  },
];

export function SaudiServices() {
  return (
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            ...
            <p className="text-muted text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
              We design specialized technology frameworks and marketing funnels to capture, engage, and convert audiences for Saudi brands.
            </p>
          </motion.div>
        </div>
