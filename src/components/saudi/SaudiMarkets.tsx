...
const markets = [
  {
    name: "Riyadh",
    desc: "The administrative capital and financial core, driving corporate hubs, multinational holdings, and Giga-projects.",
    link: null,
  },
  {
    name: "Jeddah",
    desc: "The primary commercial gateway and port city, serving trade, consumer retail, tourism, and marine logistics.",
    link: null,
  },
  {
    name: "Dammam & Khobar",
    desc: "The industrial powerhouse of the Eastern Province, managing petro-chemicals, logistics, and heavy manufacturing.",
    link: null,
  },
  {
    name: "Mecca & Medina",
    desc: "The centers of religious tourism, driving massive hospitality infrastructures and booking systems.",
    link: null,
  },
];

export function SaudiMarkets() {
  return (
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            ...
            <h2 className="font-heading text-3xl md:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white mb-6">
              Key Saudi Arabian Markets <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-accent-secondary">
                We Partner With.
              </span>
            </h2>
            <p className="text-muted text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
              We deliver localized digital growth campaigns, search maps, and performance systems to organizations throughout Saudi Arabia's major economic hubs.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {markets.map((market, index) => {
            const isClickable = market.link !== null;
