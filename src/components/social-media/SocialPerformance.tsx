...
export function SocialPerformance() {
  return (
    <section className="py-12 md:py-20 lg:py-24 px-6 relative overflow-hidden bg-black border-y border-white/5">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-full bg-gradient-to-r from-pink-600/10 via-purple-500/10 to-indigo-600/10 blur-3xl opacity-50 pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          >
            <h2 className="font-heading text-3xl md:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4">
              Real <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Results.</span>
            </h2>
            <p className="text-muted text-lg max-w-2xl mx-auto">
              Our strategies are designed to maximize impressions, drive viral growth, and convert followers into revenue.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {[
            { label: "Brands Served", value: 120, prefix: "", suffix: "+", decimals: 0 },
            { label: "Client Satisfaction", value: 98.4, prefix: "", suffix: "%", decimals: 1 },
            { label: "Reach Generated", value: 4.5, prefix: "", suffix: "M+", decimals: 1 },
            ...
            >
              ...
              <div className="text-xs md:text-sm font-semibold text-pink-400 uppercase tracking-wider">{stat.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
