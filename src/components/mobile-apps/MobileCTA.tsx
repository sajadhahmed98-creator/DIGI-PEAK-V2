  ...
  return (
    <section className="relative py-24 md:py-16 md:py-24 lg:py-32 overflow-hidden px-6">
      ...
      <div className="absolute inset-0 z-0 bg-black">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-indigo-600/20 to-cyan-600/20 rounded-full blur-[100px] pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center glass p-8 md:p-16 rounded-[2rem] border border-white/10 shadow-2xl">
        ...
        >
          <h2 className="font-heading text-3xl md:text-5xl lg:text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 text-white leading-tight">
            Ready To Launch <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-blue-400 to-cyan-400">Your Mobile App?</span>
          </h2>
          <p className="text-lg md:text-xl text-muted mb-10 max-w-2xl mx-auto leading-relaxed">
            Let's build a powerful mobile experience that helps your business grow faster. Capture clients, generate bookings, and secure recurring sales.
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link
              href="/contact"
              className="w-full sm:w-auto btn-primary group flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold bg-gradient-to-r from-indigo-600 to-cyan-600 hover:from-indigo-500 hover:to-cyan-500 border-none shadow-[0_0_20px_rgba(99,102,241,0.3)] text-white"
            >
              Get Free Proposal
