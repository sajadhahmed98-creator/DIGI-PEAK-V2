    ...
    <section className="relative overflow-hidden pt-36 pb-20 md:pt-52 md:pb-28 px-6 bg-black">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <pattern id="wlHeroGrid" width="60" height="60" patternUnits="userSpaceOnUse">
              <path d="M 60 0 L 0 0 0 60" fill="none" stroke="#6366f1" strokeWidth="0.5" strokeOpacity="0.4" />
            </pattern>
            <rect width="100%" height="100%" fill="url(#wlHeroGrid)" />
          </svg>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl w-full text-center flex flex-col items-center">
        ...
        >
          ...
          <span>White Label Agency Program</span>
        </motion.div>
        ...
        >
          Deliver premium websites, SEO campaigns, digital marketing services, branding projects, and AI solutions under your own agency brand while Digipeak handles fulfillment behind the scenes.
        </motion.p>
