...
import { ArrowRight, MessageSquare, Landmark } from "lucide-react";
    ...
    <section className="relative overflow-hidden pt-36 pb-20 md:pt-52 md:pb-28 px-6 bg-black">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <pattern id="resellerHeroGrid" width="60" height="60" patternUnits="userSpaceOnUse">
              <path d="M 60 0 L 0 0 0 60" fill="none" stroke="#6366f1" strokeWidth="0.5" strokeOpacity="0.4" />
            </pattern>
            <rect width="100%" height="100%" fill="url(#resellerHeroGrid)" />
          </svg>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl w-full text-center flex flex-col items-center">
        ...
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-indigo-500/20 bg-indigo-500/5 px-4.5 py-1.5 text-xs font-semibold text-indigo-300 tracking-wide"
        >
        ...
        >
          Partner with Digipeak and offer websites, SEO, digital marketing, branding, AI solutions, and automation services without building your own delivery team.
        </motion.p>
        ...
        >
          <button
            onClick={() => handleScrollToSection("reseller-application-form-section")}
          ...
          <button
            onClick={() => handleScrollToSection("earnings-calculator-section")}
