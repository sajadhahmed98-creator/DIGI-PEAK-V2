  ...
  return (
    <section className="py-10 md:py-16 lg:py-20 px-6 relative z-10 bg-black border-t border-white/5">
      <div className="mx-auto max-w-4xl w-full">
        ...
        {/* Glow Ring */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[400px] w-[400px] rounded-full bg-indigo-600/5 blur-[120px] pointer-events-none" />
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-muted text-sm md:text-base mb-8 max-w-lg mx-auto leading-relaxed">
              Start offering premium digital growth services without building a delivery team.
            </p>
