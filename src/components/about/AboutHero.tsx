...
import { ArrowRight, Globe, Sparkles, Rocket, Building2, MessageCircle } from "lucide-react";
import { useEffect, useState } from "react";

const floatingCards = [
  { icon: Globe, title: "Global Reach", val: "8+ Markets", color: "text-accent-primary border-accent-primary/20" },
  { icon: Building2, title: "Founded", val: "2022", color: "text-accent-secondary border-accent-secondary/20" },
  { icon: Rocket, title: "Services", val: "14+", color: "text-indigo-400 border-indigo-500/20" },
  { icon: Sparkles, title: "Focus", val: "Growth", color: "text-emerald-400 border-emerald-500/20" },
];
  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20 md:pt-48 md:pb-32 px-6 min-h-[95vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-10">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <pattern id="aboutHeroGrid" width="60" height="60" patternUnits="userSpaceOnUse">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none hidden lg:block">
        ...
        >
          <div className="text-[10px] font-bold text-white uppercase tracking-wider font-mono mb-2">🌏 HQ Location</div>
          <div className="text-sm font-bold text-accent-primary">Sri Lanka</div>
          <div className="text-[9px] text-muted mt-1">Serving businesses globally</div>
        </motion.div>
        ...
        >
          <div className="text-[10px] font-bold text-white uppercase tracking-wider font-mono mb-2">🚀 Digital Growth</div>
          <div className="space-y-1.5">
            {["Web Design", "SEO", "AI Solutions", "Branding"].map((s) => (
      ...
      <div className="relative z-20 mx-auto max-w-7xl w-full">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="text-accent-primary font-bold">About Digipeak Agency</span>
          </motion.div>
          ...
          >
            Founded in 2022, Digipeak helps businesses grow through web design, SEO, digital marketing,
            branding, automation, AI solutions and technology-driven strategies — serving clients locally
            and internationally.
          </motion.p>
