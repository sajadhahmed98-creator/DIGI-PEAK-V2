  ...
  return (
    <footer className="mt-auto border-t border-white/[0.08] bg-background/90 backdrop-blur-xl relative overflow-hidden">
      ...
      <div className="px-6 py-12 md:py-16 relative z-10">
        <div className="mx-auto max-w-[1400px] grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          {/* Link Columns Grid */}
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 text-[13px] text-muted">
                ...
                <li><AnimatedLink href="/resources/seo-guides">SEO Guides</AnimatedLink></li>
        ...
        {/* Bottom Legal Row */}
        <div className="mx-auto max-w-[1400px] mt-16 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-muted/60 gap-4">
