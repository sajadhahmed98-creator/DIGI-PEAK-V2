...
export function MarketingPerformance() {
  return (
    <section className="py-12 md:py-20 lg:py-24 px-6 relative overflow-hidden bg-black border-y border-white/5">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-full bg-gradient-to-r from-orange-600/10 via-amber-500/10 to-orange-600/10 blur-3xl opacity-50 pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          >
            <h2 className="font-heading text-3xl md:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4">
              Proven <span className="text-gradient-primary">Performance.</span>
            </h2>
            <p className="text-muted text-lg max-w-2xl mx-auto">
              We don't sell vanity metrics. We measure success strictly by revenue generated and customer acquisition cost.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {[
            { label: "Lead Growth", value: 185, prefix: "+", suffix: "%", decimals: 0 },
            { label: "Average ROAS", value: 4.2, prefix: "", suffix: "x", decimals: 1 },
            { label: "Client Satisfaction", value: 98.4, prefix: "", suffix: "%", decimals: 1 },
            { label: "Brands Scaled", value: 120, prefix: "", suffix: "+", decimals: 0 },
          ].map((stat, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              <div className="text-xs md:text-sm font-semibold text-orange-400 uppercase tracking-wider">{stat.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
