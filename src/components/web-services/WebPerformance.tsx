...
export function WebPerformance() {
  return (
    <section className="py-12 md:py-20 lg:py-24 px-6 relative overflow-hidden border-y border-white/5 bg-white/[0.01]">
      {/* Background Gradients */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-full bg-gradient-to-r from-blue-600/10 via-cyan-500/10 to-blue-600/10 blur-3xl opacity-50 pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          >
            <h2 className="font-heading text-3xl md:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-4">
              Proven <span className="text-gradient-secondary">Digital Excellence.</span>
            </h2>
            <p className="text-muted text-lg max-w-2xl mx-auto">
              We don't just build websites; we engineer highly profitable digital assets.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {[
            { label: "Websites Delivered", value: 120, prefix: "", suffix: "+", decimals: 0 },
            { label: "Client Satisfaction", value: 98.4, prefix: "", suffix: "%", decimals: 1 },
            { label: "Conversion Growth", value: 3.8, prefix: "", suffix: "x", decimals: 1 },
            ...
            >
              ...
              <div className="text-sm font-semibold text-blue-400 uppercase tracking-wider">{stat.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
