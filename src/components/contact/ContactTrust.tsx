...
export function ContactTrust() {
  ...
  return (
    <section className="py-10 md:py-16 lg:py-20 px-6 border-t border-white/5 bg-white/[0.01] relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-accent-primary/5 rounded-full blur-[100px]" />
      </div>
